    ...
    <v-card>
      ...
      <v-card-text>
        <v-form v-model="isTaskValid">
          ...
          <v-text-field variant="solo" type="date" label="Start date" v-model="task.startDate" :rules="[ rules.validBirthDate ]"></v-text-field>
          <v-text-field variant="solo" type="date" label="End date" v-model="task.endDate" :rules="[  ]"></v-text-field>
          <v-select
